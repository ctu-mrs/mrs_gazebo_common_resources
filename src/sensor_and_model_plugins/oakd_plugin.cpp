...
public:
  ...
  void createStaticTransforms() {
    ...
    static_transform_depth_base.transform.translation.x = 0.0231;
    static_transform_depth_base.transform.translation.y = -0.0485;
    static_transform_depth_base.transform.translation.z = -0.010;
    quat.setRPY(0, 0, 0);
    ...
    static_transform_color_base.transform.translation.x = 0.0231;
    static_transform_color_base.transform.translation.y = -0.0485;
    static_transform_color_base.transform.translation.z = -0.010;
    ...
    static_transform_ir1_base.transform.translation.x = 0.0231;
    static_transform_ir1_base.transform.translation.y = -0.011;
    static_transform_ir1_base.transform.translation.z = -0.010;
    ...
    static_transform_ir2_base.transform.translation.x = 0.0231;
    static_transform_ir2_base.transform.translation.y = -0.086;
    static_transform_ir2_base.transform.translation.z = -0.010;
