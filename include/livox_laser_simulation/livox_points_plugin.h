...
private:
  ...
  void InitializeRays(std::vector<std::pair<int, AviaRotateInfo>>& points_pair, boost::shared_ptr<physics::LivoxOdeMultiRayShape>& ray_shape);
  ...
  double sensor_x, sensor_y, sensor_z, sensor_roll, sensor_pitch, sensor_yaw;
  double lidar_x, lidar_y, lidar_z, lidar_roll, lidar_pitch, lidar_yaw;
